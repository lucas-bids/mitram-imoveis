        ...
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          <div className="flex items-center gap-6">
            ...
            <nav className="hidden md:flex space-x-4">
              <Link href="/admin/imoveis" className="text-sm hover:text-mitram-gold transition-colors font-medium">
                Imóveis
              </Link>
              <Link href="/admin/imoveis/lixeira" className="text-sm hover:text-mitram-gold transition-colors">
                Lixeira
              </Link>
            </nav>
          </div>
